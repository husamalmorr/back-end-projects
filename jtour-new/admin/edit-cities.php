...
$id=$_GET['id'];
	$query=mysqli_query($conn,"select * from cities where id='$id'");
	...
	<form method="post" enctype="multipart/form-data"> 
      ...
      <div class="modal-body mx-3">
        ...
        <div class="md-form mb-5">
          ...
          <input type="text" id="defaultForm-email" name="name" value="<?php echo $row['name'];?>" class="form-control validate" required>
        </div>
