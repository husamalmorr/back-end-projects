<?php include("controllers/user-control.php"); session_start();
	...
	$password=md5($_POST['password']);
							$sql2=mysqli_query($conn,"update users set fullname ='$name',email='$email',password='$password' where id='$id'");
  if($sql2)
  {
	$msg ="<script> alert('successfull updated'); window.location.href='./edit-user.php?id=".$id."'</script>";
  echo $msg;
  }
}
	  ?>
