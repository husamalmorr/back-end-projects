<?php include("controllers/navbar-control.php");
session_start();
 	  if($_SESSION['id']==null)
	  {
...
<?php include("controllers/sidebar.php");?>
  <!-- Content -->
  <div id="content">
    <nav class="navbar navbar-default" style="background:background-color: #f5f5f5;border:none;">
...
<a href="" data-toggle="modal" data-target="#modalLoginForm2"> <input type="button" value="update logo" class="add-btn">
</a>
...
<tr class="header">
  ...
  <?php while($row=mysqli_fetch_array($query)){
	  ?>
  <td id="<?php echo $row['id']; ?>"> <?php echo $i++?> </td>
    <td><?php echo $row['item'];?></td>
    <td><?php echo $row['link'];?></td>
    <td><?php echo $row['lang'];?></td>
    <td><?php echo $row['status'];?></td>
    <td><a href="edit-navbar.php?id=<?php echo $row['id'];?>"> <i class="fa fa-edit"> </i> </a> </td>
	<?php   if(mysqli_num_rows($query)>1){?>
		  		    <td><a href="navbar.php?id=<?php echo $row['id'];?>&del=delete" onClick="return confirm('are you want to delete user?')"> <i class="fa fa-trash"> </i> </a></td>
	<?php }?>
<?php  if(isset($_GET['del']))
		  {
			  if(mysqli_num_rows($query)>1){
		          $query4=mysqli_query($conn,"delete from navbar  where id ='".$_GET['id']."'");
				  	$msg ="<script> alert('successfull deleted'); window.location.href='./navbar.php'</script>";
...
<div class="modal fade" id="modalLoginForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
  <form method="post" action="controllers/navbar-control.php">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body mx-3">
        ...
        <div class="md-form mb-4">
          ...
          <input type="text" name="link" id="defaultForm-pass" class="form-control validate">
        </div>
		<div class="md-form mb-4">
  ...
  <div class="modal-dialog" role="document">
	...
	<form method="post" action="" enctype="multipart/form-data">
      ...
      <div class="modal-body mx-3">
		  ...
		  <div class="md-form mb-4">
          <label data-error="wrong" data-success="right" for="defaultForm-pass">logo</label>
