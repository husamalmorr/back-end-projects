<?php include("controllers/career-control.php");
session_start();
 	  if($_SESSION['id']==0)
	  {
...
<tr class="header">
 ...
 <td><?php echo $row['name'];?></td>
    ...
    <td><a target="_blank" href="../files/<?php echo $row['file'];?>"> <?php echo $row['file'];?> </a></td>
...
<?php  if(isset($_GET['del']))
		  {
		          $query4=mysqli_query($conn,"delete from career  where id ='".$_GET['id']."'");
