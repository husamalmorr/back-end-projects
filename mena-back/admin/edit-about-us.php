...
if (isset($_POST['save'])) {
 ...
 $details = $_POST['details'];
    $status = $_POST['status'];
 		    ...
 		    $sql = "update aboutus set details='$details',status='$status' where id='$id'";
			  mysqli_query($conn, $sql);

				$msg ="<script> alert('successfull updated'); window.location.href='./about-us.php'</script>";
echo $msg;
  ...
  <div class="modal-dialog" role="document">
	...
	<form method="post" enctype="multipart/form-data"> 
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold">Edit about us</h4>
      ...
      <div class="modal-body mx-3">
          ...
          <textarea type="text" id="summernote" name="details" class="form-control validate" required> <?php echo $row2['details'];?> </textarea>
        </div>
