<?php include("controllers/testi-control.php");
session_start();
 	  if($_SESSION['id']==0)
	  {
...
<div class="md-form mb-4">
 ...
 <a href="testi-title.php"> <input type="button" value="testimonial title" class="add-btn">
</a>
<table id="myTable">
<tr class="header">
  ...
  <td> <?php echo $i++;?> </td>
    ...
    <td><a href="edit-testi.php?id=<?php echo $row['id'];?>"> <i class="fa fa-edit"> </i> </a> </td>
		  		    <td><a href="testi.php?id=<?php echo $row['id'];?>&del=delete" onClick="return confirm('are you want to delete user?')"> <i class="fa fa-trash"> </i> </a></td>
<?php  if(isset($_GET['del']))
		  {if(mysqli_num_rows($query)>1){
		          $query4=mysqli_query($conn,"delete from testiitems  where id ='".$_GET['id']."'");
				  	$msg ="<script> alert('successfull deleted'); window.location.href='./testi.php'</script>";
...
<div class="md-form mb-5">
		...
		<div class="md-form mb-5">
          ...
          <input type="text" name="details" id="defaultForm-email" class="form-control validate">
        </div>
		<div class="md-form mb-5">
          <label data-error="wrong" data-success="right" for="defaultForm-email">major</label>
          <input type="text" name="major" id="defaultForm-email" class="form-control validate">
        </div>
		  <div class="md-form mb-4">
