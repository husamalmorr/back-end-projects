<?php include("controllers/curriculums-control.php");
session_start();
 	  if($_SESSION['id']==0)
	  {
...
<tr class="header">
  ...
  <td> <?php echo $i++;?> </td>
    ...
    <td><a href="edit-curriculums.php?id=<?php echo $row['id'];?>"> <i class="fa fa-edit"> </i> </a> </td>
		  		    <td><a href="curriculums.php?id=<?php echo $row['id'];?>&del=delete" onClick="return confirm('are you want to delete user?')"> <i class="fa fa-trash"> </i> </a></td>
<?php  if(isset($_GET['del']))
		  {
		          $query4=mysqli_query($conn,"delete from curriculums  where id ='".$_GET['id']."'");
				  	$msg ="<script> alert('successfull deleted'); window.location.href='./curriculums.php'</script>";
  ...
  <div class="modal-dialog" role="document">
	...
	<form method="post" action="" enctype="multipart/form-data">
      ...
      <div class="modal-body mx-3">
	  	  			 <div class="md-form mb-4">
		          <label data-error="wrong" data-success="right" for="defaultForm-pass">Course Name</label>
		  <select name="item" id="browser2" class="form-control validate">
    ...
    <option value="<?php echo $row3['item'];?>"><?php echo $row3['item'];?></option>
		...
		<div class="md-form mb-5">
          ...
          <textarea  id="summernote" name="description" id="defaultForm-email" class="form-control validate"> </textarea>
        </div>
		<div class="md-form mb-4">
...
function exportReportToExcel() {
  ...
  TableToExcel.convert(table[0], { // html code may contain multiple tables so here we are refering to 1st table tag
    name: `curriculums.xlsx`, // fileName you could use any name
    sheet: {
