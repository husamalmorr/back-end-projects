<?php include("controllers/partners-control.php");
session_start();
 	  if($_SESSION['id']==0)
	  {
...
<tr class="header">
  ...
  <td> <?php echo $i++;?> </td>
    ...
    <td><a href="edit-partners.php?id=<?php echo $row['id'];?>"> <i class="fa fa-edit"> </i> </a> </td>
		  		    <td><a href="partners.php?id=<?php echo $row['id'];?>&del=delete" onClick="return confirm('are you want to delete user?')"> <i class="fa fa-trash"> </i> </a></td>
<?php  if(isset($_GET['del']))
		  {
		          $query4=mysqli_query($conn,"delete from partners  where id ='".$_GET['id']."'");
				  	$msg ="<script> alert('successfull deleted'); window.location.href='./partners.php'</script>";
