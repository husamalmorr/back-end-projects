...
$id=$_GET['id'];
	$query=mysqli_query($conn,"select * from servicesitems where id='$id'");
		$query2=mysqli_query($conn,"select distinct item from tracksitems");

	$row2=mysqli_fetch_array($query);
if (isset($_POST['save'])) {
    $details = $_POST['details'];
 		    $sql = "update servicesitems set 
			details='$details' where id='$id'";
			    mysqli_query($conn, $sql);
				$msg ="<script> alert('successfull updated'); window.location.href='./edit-services-details.php?id=".$id."'</script>";
echo $msg;
    // Execute query
  ...
  <div class="modal-dialog" role="document">
	...
	<form method="post" enctype="multipart/form-data"> 
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold">Edit service details</h4>
      ...
      <div class="modal-body mx-3">
          ...
          <textarea name="details" id="summernote" class="form-control validate"> <?php echo $row2['details'];?> </textarea>
        </div>
