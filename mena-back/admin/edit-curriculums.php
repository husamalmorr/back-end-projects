...
$id=$_GET['id'];
	$query=mysqli_query($conn,"select * from curriculums where id='$id'");
...
if (isset($_POST['save'])) {
 ...
 $description = $_POST['description'];
    $lang = $_POST['lang'];
    $status = $_POST['status'];
 		    $sql = "update curriculums set item='$item',status='$status',description='$description',lang='$lang' where id='$id'";
			    mysqli_query($conn, $sql);
				$msg ="<script> alert('successfull updated'); window.location.href='./edit-curriculums.php?id=".$id."'</script>";
echo $msg;
    // Execute query
  ...
  <div class="modal-dialog" role="document">
	...
	<form method="post" enctype="multipart/form-data"> 
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold">Edit curriculum</h4>
      ...
      <div class="modal-body mx-3">
		  ...
		  <option value="<?php echo $row2['item'];?>"><?php echo $row2['item'];?></option>
    ...
    <option value="<?php echo $row3['item'];?>"><?php echo $row3['item'];?></option>
		 ...
		 <textarea type="text" id="summernote" name="description" class="form-control validate" required> <?php echo $row2['description'];?> </textarea>
