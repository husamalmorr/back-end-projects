...
$id=$_GET['id'];
	$query=mysqli_query($conn,"select * from trackstitle where id='$id'");
...
if (isset($_POST['save'])) {
 ...
 $subtitle = $_POST['subtitle'];
    $lang = $_POST['lang'];
    $status = $_POST['status'];
 		    $sql = "update trackstitle set title='$title',subtitle='$subtitle',status='$status',lang='$lang' where id='$id'";
			    mysqli_query($conn, $sql);
				$msg ="<script> alert('successfull updated'); window.location.href='./tracks-title.php'</script>";
echo $msg;
    // Execute query
  ...
  <div class="modal-dialog" role="document">
	...
	<form method="post" enctype="multipart/form-data"> 
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold">Edit track title</h4>
