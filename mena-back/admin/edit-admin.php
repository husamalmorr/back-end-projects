<?php include("controllers/admin-control.php"); session_start();
	...
	$password=md5($_POST['password']);
							$sql2=mysqli_query($conn,"update admins set name ='$name',email='$email',password='$password' where id='$id'");
  if($sql2)
  {
	$msg ="<script> alert('successfull updated'); window.location.href='./admin.php'</script>";
  echo $msg;
  }
}
	  ?>
	...
	<form method="post"> 
      ...
      <div class="modal-body mx-3">
        ...
        <div class="md-form mb-5">
          ...
          <input type="text" id="defaultForm-email" name="name" value="<?php echo $row3['name'];?>" class="form-control validate" required>
        </div>
