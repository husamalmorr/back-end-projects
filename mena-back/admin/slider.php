<?php include("controllers/slider-control.php");
session_start();
 	  if($_SESSION['id']==0)
	  {
...
<tr class="header">
  ...
  <td> <?php echo $i++;?> </td>
    ...
    <td><img style="width:100px" src="../images/<?php echo $row['bg']?>"/></td>
	<td><?php echo $row['status'];?></td>
	<td><?php echo $row['lang'];?></td>
    <td><a href="edit-slider.php?id=<?php echo $row['id'];?>"> <i class="fa fa-edit"> </i> </a> </td>
		  		    <td><a href="slider.php?id=<?php echo $row['id'];?>&del=delete" onClick="return confirm('are you want to delete user?')"> <i class="fa fa-trash"> </i> </a></td>
<?php  if(isset($_GET['del']))
		  {
		          $query4=mysqli_query($conn,"delete from slider  where id ='".$_GET['id']."'");
				  	$msg ="<script> alert('successfull deleted'); window.location.href='./slider.php'</script>";
...
<div class="md-form mb-5">
          ...
          <input type="text" name="title" id="defaultForm-email" class="form-control validate">
        </div>
		<div class="md-form mb-5">
          <label data-error="wrong" data-success="right" for="defaultForm-email">sub-title</label>
          <input type="text" name="list" id="defaultForm-email" class="form-control validate">
        </div>
		  <div class="md-form mb-4">
          <label data-error="wrong" data-success="right" for="defaultForm-pass">background Image (1800 x 1006)</label>
