...
if (isset($_POST['save'])) {
 $category = $_POST['category'];
    ...
    $status = $_POST['status'];
 		    ...
 		    $sql = "update category set name='$category',status='$status',lang='$lang' where id='$id'";
			    mysqli_query($conn, $sql);
				$msg ="<script> alert('successfull updated'); window.location.href='./category.php'</script>";
echo $msg;
    // Execute query
	...
	<form method="post" enctype="multipart/form-data"> 
      ...
      <div class="modal-body mx-3">
        ...
        <div class="md-form mb-5">
          ...
          <input type="text" id="defaultForm-email" name="category" value="<?php echo $row2['name'];?>" class="form-control validate" required>
        </div>
