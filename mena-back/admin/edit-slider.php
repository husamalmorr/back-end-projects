...
if($filename!=''){
 		    $sql = "update slider set title='$title',subtitle='$list',bg='$filename',status='$status',lang='$lang' where id='$id'";
			 mysqli_query($conn, $sql);
				$msg ="<script> alert('successfull updated'); window.location.href='./slider.php'</script>";
echo $msg;
    // Execute query
   
}
if($filename ==''){
 		    $sql = "update slider set title='$title',subtitle='$list',status='$status',lang='$lang' where id='$id'";
			    mysqli_query($conn, $sql);
				$msg ="<script> alert('successfull updated'); window.location.href='./slider.php'</script>";
echo $msg;
    // Execute query
      ...
      <div class="modal-body mx-3">
        ...
        <div class="md-form mb-5">
		 ...
		 <div class="md-form mb-5">
          ...
          <input type="text" id="defaultForm-email" name="list" value="<?php echo $row2['subtitle'];?>" class="form-control validate" required>
        </div>
