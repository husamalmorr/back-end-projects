		  ...
		  <?php while($row2=mysqli_fetch_array($query2)){?>
            <div class="u-align-right-xl u-border-2 u-border-grey-10 u-container-style u-list-item u-radius-11 u-repeater-item u-shape-round">
              <div class="u-container-layout u-similar-container u-container-layout-1">
                ...
                <h3 class="u-align-right-lg u-align-right-md u-align-right-sm u-align-right-xs u-text u-text-default-xl u-text-grey-50 u-text-3"> <?php echo $row2['duration'];?> ساعة</h3>
                ...
                <a href="Course-details.php?id=<?php echo $row2['id'];?>" class="u-border-none u-btn u-btn-round u-button-style u-custom-color-3 u-radius-50 u-btn-2">سجل الآن</a>
