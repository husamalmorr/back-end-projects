                ...
                <div class="col-lg-4">
                    <div class="singel-course">
                        ...
                        <div class="cont"> 
							...
							<div class="name">
                                    <a class="main-btn"style="padding:10px;" href="Course-details.php?id=<?php echo $row['id'];?>" tabindex="0"><h6>إعرف المزيد</h6></a>
                                </div>
                                <div class="admin">
                                    <ul>
                                        <li><a href="#"><span><?php echo $row['duration'];?> ساعة</span></a></li>
                ...
                <div class="col-lg-12">
                    <div class="singel-course">
                        ...
                        <div class="cont"> 
                            ...
                            <div class="course-teacher">
							<div class="name">
                                    <a class="main-btn"style="padding:10px;margin-top:15px;" href="Course-details.php?id=<?php echo $row2['id'];?>" tabindex="0"><h6>إعرف المزيد</h6></a>
                                </div>
                                <div class="admin">
                                    <ul>
                                        <li><a href="#"><span><?php echo $row2['duration'];?> ساعة</span></a></li>
