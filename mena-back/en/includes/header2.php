                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="header-opening-time text-lg-right text-center">
                            <p>Opening Hours : <?php echo $row['workinghours'];?></p>
                        </div>
                    </div>
                </div> <!-- row -->
            </div> <!-- container -->
                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="support-button float-right d-none d-md-block">
                            ...
                            <div class="button float-left">
                                <a href="#" class="main-btn" data-toggle="modal" data-target="#exampleModal2">Apply Now</a>
                            </div>
                        </div>
                    </div>
                </div> <!-- row -->
...
<div class="modal-content">
    <div class="contact-from">
                        ...
                        <div class="section-title">
                            ...
                            <h5>Apply Now</h5>
                            <h2 style="color:#07294d">Apply with us and enjoy the best courses</h2>
