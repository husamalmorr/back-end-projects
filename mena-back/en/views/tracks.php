        ...
        <div class="u-expanded-width-lg u-expanded-width-xl u-tab-links-align-center u-tabs u-tabs-1">
          <ul class="u-spacing-15 u-tab-list u-unstyled" role="tablist">
            <li class="u-tab-item" role="presentation">
              <a class="active u-active-custom-color-3 u-button-style u-tab-link u-text-active-white u-text-grey-60 u-text-hover-grey-75 u-tab-link-1" id="link-tab-0da5" href="#tab-0da5" role="tab" aria-controls="tab-0da5" aria-selected="true">View All</a>
            </li>
            <li class="u-tab-item" role="presentation">
              <a class="u-active-custom-color-3 u-button-style u-tab-link u-text-active-white u-text-grey-60 u-text-hover-grey-75 u-tab-link-2" id="link-tab-14b7" href="#tab-14b7" role="tab" aria-controls="tab-14b7" aria-selected="false">IT</a>
            </li>
            <li class="u-tab-item" role="presentation">
              <a class="u-active-custom-color-3 u-button-style u-tab-link u-text-active-white u-text-grey-60 u-text-hover-grey-75 u-tab-link-3" id="link-tab-2917" href="#tab-2917" role="tab" aria-controls="tab-2917" aria-selected="false">Busniess</a>
            </li>
            <li class="u-tab-item" role="presentation">
              <a class="u-active-custom-color-3 u-button-style u-tab-link u-text-active-white u-text-grey-60 u-text-hover-grey-75 u-tab-link-4" id="link-tab-2715" href="#tab-2715" role="tab" aria-controls="tab-2715" aria-selected="false">Languages</a>
            </li>
            <li class="u-tab-item" role="presentation">
              <a class="u-active-custom-color-3 u-button-style u-tab-link u-text-active-white u-text-grey-60 u-text-hover-grey-75 u-tab-link-5" id="link-tab-a19f" href="#tab-a19f" role="tab" aria-controls="tab-a19f" aria-selected="false">Engineering</a>
            </li>
			<li class="u-tab-item" role="presentation">
              <a class="u-active-custom-color-3 u-button-style u-tab-link u-text-active-white u-text-grey-60 u-text-hover-grey-75 u-tab-link-5" id="link-tab-a19f" href="#tab-a19f2" role="tab" aria-controls="tab-a19f" aria-selected="false">Education</a>
            </li>
          </ul>
				  ...
				  <?php while($row2=mysqli_fetch_array($query2)){?>
                   <div class="u-align-right u-border-2 u-border-grey-10 u-container-style u-list-item u-radius-11 u-repeater-item u-shape-round">
                      <div class="u-container-layout u-similar-container u-container-layout-7">
                        ...
                        <a href="Categories.php?track=<?php echo $row2['item'];?>&category='<?php echo $row2['category'];?>'" class="u-border-none u-btn u-btn-round u-button-style u-custom-color-3 u-radius-50 u-btn-5">find out more</a>
                ...
                <div class="u-expanded-width-lg u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-layout-grid u-list u-list-2">
				  ...
				  <div class="u-align-right u-border-2 u-border-grey-10 u-container-style u-list-item u-radius-11 u-repeater-item u-shape-round">
                      <div class="u-container-layout u-similar-container u-container-layout-7">
                        ...
                        <a href="Categories.php?track=<?php echo urldecode($row3['item']);?>&category='<?php echo trim($row3['category']);?>'" class="u-border-none u-btn u-btn-round u-button-style u-custom-color-3 u-radius-50 u-btn-5">find out more</a>
                        <img class="u-image u-image-contain u-image-default u-image-10" src="images/58738756f3a71010b5e8ef44.png" alt="" data-image-width="1280" data-image-height="263">
                      </div>
                    </div>
                ...
                <div class="u-expanded-width-lg u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-layout-grid u-list u-list-2">
				  ...
				  <div class="u-align-right u-border-2 u-border-grey-10 u-container-style u-list-item u-radius-11 u-repeater-item u-shape-round">
                      <div class="u-container-layout u-similar-container u-container-layout-7">
                        ...
                        <a href="Categories.php?track=<?php echo $row4['item'];?>&category='<?php echo $row4['category'];?>'" class="u-border-none u-btn u-btn-round u-button-style u-custom-color-3 u-radius-50 u-btn-5">find out more</a>
                        <img class="u-image u-image-contain u-image-default u-image-10" src="images/58738756f3a71010b5e8ef44.png" alt="" data-image-width="1280" data-image-height="263">
                      </div>
                    </div>     
				   <?php } ?> 					
				   ...
				   <?php while($row5=mysqli_fetch_array($query5)){?>
                    <div class="u-align-right u-border-2 u-border-grey-10 u-container-style u-list-item u-radius-11 u-repeater-item u-shape-round">
                      <div class="u-container-layout u-similar-container u-container-layout-7">
                        ...
                        <a href="Categories.php?track=<?php echo $row5['item'];?>&category='<?php echo $row5['category'];?>'" class="u-border-none u-btn u-btn-round u-button-style u-custom-color-3 u-radius-50 u-btn-5">find out more</a>
                        <img class="u-image u-image-contain u-image-default u-image-10" src="images/58738756f3a71010b5e8ef44.png" alt="" data-image-width="1280" data-image-height="263">
                      </div>
                    </div>
				   <?php } ?> 
				  ...
				  <?php while($row6=mysqli_fetch_array($query6)){?>
                    <div class="u-align-right u-border-2 u-border-grey-10 u-container-style u-list-item u-radius-11 u-repeater-item u-shape-round">
                      <div class="u-container-layout u-similar-container u-container-layout-7">
                        ...
                        <a href="Categories.php?track=<?php echo $row6['item'];?>&category='<?php echo $row6['category'];?>'" class="u-border-none u-btn u-btn-round u-button-style u-custom-color-3 u-radius-50 u-btn-5">find out more</a>
                        <img class="u-image u-image-contain u-image-default u-image-10" src="images/58738756f3a71010b5e8ef44.png" alt="" data-image-width="1280" data-image-height="263">
                      </div>
                    </div>
<?php } ?> 
				  ...
				  <?php while($row7=mysqli_fetch_array($query7)){?>
                    <div class="u-align-right u-border-2 u-border-grey-10 u-container-style u-list-item u-radius-11 u-repeater-item u-shape-round">
                     ...
                     <h3 class="u-text u-text-default u-text-grey-50 u-text-16"><?php echo $row7['category'];?></h3>
                        ...
                        <a href="Categories.php?track=<?php echo $row7['item'];?>&category='<?php echo $row7['category'];?>'" class="u-border-none u-btn u-btn-round u-button-style u-custom-color-3 u-radius-50 u-btn-5">find out more</a>
                        <img class="u-image u-image-contain u-image-default u-image-10" src="images/58738756f3a71010b5e8ef44.png" alt="" data-image-width="1280" data-image-height="263">
                      </div>
                    </div>
					  <?php }?>
