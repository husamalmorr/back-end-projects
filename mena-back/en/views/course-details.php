                    ...
                    <div class="corses-singel-left mt-30">
                        ...
                        <div class="corses-tab mt-30">
                            <ul class="nav nav-justified" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="active show" id="overview-tab" data-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-selected="true">Overview</a>
                                </li>
                                <li class="nav-item">
                                    <a id="curriculam-tab" data-toggle="tab" href="#curriculam" role="tab" aria-controls="curriculam" aria-selected="false" class="">curriculum</a>
                                </li>
                          <!--      <li class="nav-item">
                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="course-features mt-30">
                               <h4>Course Features </h4>
                                <ul>
                                    <li><i class="fa fa-clock-o"></i>Duaration : <span><?php echo $row['duration'];?> Hours</span></li>
                                    <li><i class="fa fa-clone"></i>Track : <span><?php echo $row['track'];?></span></li>
                                    <li><i class="fa fa-clone"></i>Category : <span><?php echo $row['category'];?></span></li>
                                </ul>
                                <div class="price-button pt-10">
                                    <span>Price : <b><?php echo $row['price'];?> JOD</b></span>
                                    <a href="#" class="main-btn" data-toggle="modal" data-target="#exampleModal3">Sign Up Now</a>
                                </div>
                            </div> <!-- course features -->
                        </div>
                        <div class="col-lg-12 col-md-6">
