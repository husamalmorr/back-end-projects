...
$query=mysqli_query($con,"insert into main(projectname,mainname,description,startdate,enddate,owner)values('$projectname','$mainname','$description','$startdate','$enddate','$id')");
$extra="add-main-task/$id";//
      ...
      <div class="container">
        ...
        <div class="header-content header-style-five position-relative d-flex align-items-center justify-content-between">
          ...
          <div class="page-heading">
            <h6 class="mb-0">اضافة مهمة رئيسية</h6>
          </div>
          <!-- Navbar Toggler-->
            ...
            <div class="contact-form">
              <form method="post" action="">
                  ...
                  <select class="form-select" name="projectname">
				   <?php 
				   $id=$_GET['id'];
				   $query2=mysqli_query($con,"select projectname from projects where owner='$id'");
			  ...
			  ?>
                  ...
                  <?php }?>
				   ...
				   <div class="form-group mb-3">
                  <input class="form-control" name="mainname" type="text" placeholder="اسم المهمة" required>
                </div>
                <div class="form-group mb-3">
                ...
                <button type="submit" name="submit"class="btn btn-primary w-100">اضافة مهمة رئيسية</button>
              </form>
            </div>
          </div>
        </div>
