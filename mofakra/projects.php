      ...
      <div class="container">
        ...
        <div class="header-content header-style-five position-relative d-flex align-items-center justify-content-between">
          ...
          <div class="page-heading">
            <h6 class="mb-0"><?php echo $_GET['category'];?> </h6>
          </div>
          <!-- Navbar Toggler-->
      ...
      <div class="container">
        <div class="card">
          <div class="card-body p-3">
			...
			$query2=mysqli_query($con,"select * from main inner join projects on projects.projectname=main.projectname and main.owner=projects.owner where main.owner='$id' and projects.category='$category'  group by main.projectname  ");
