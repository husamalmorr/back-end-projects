    ...
    <div class="header-area" id="headerArea">
      <div class="container">
        ...
        <div class="header-content header-style-five position-relative d-flex align-items-center justify-content-between">
          <!-- Back Button-->
          <div class="back-button"><a href="add-project/<?php echo $_GET['id'];?>"> <i class="fa fa-plus" style="color:white"> </i> </a> </div>
          <!-- Page Title-->
          <div class="page-heading">
            <h6 class="mb-0">المشاريع</h6>
          </div>
          <!-- Navbar Toggler-->
          <div class="navbar--toggler" id="affanNavbarToggler" style="right: 4px;"><span class="d-block"></span><span class="d-block"></span><span class="d-block"></span></div>
        </div>
      </div>
    </div>
    <!-- Dark mode switching-->
      ...
      <div class="container">
        <div class="card">
          <div class="card-body p-3">
			...
			<?php 
			$id=$_GET['id'];
			$query2=mysqli_query($con,"select * from main inner join projects on projects.projectname=main.projectname and main.owner=projects.owner where main.owner='$id'  group by main.projectname  ");
            ...
            <!-- Page Item-->	 <a   id="size" class="page--item" href="details-project/<?php echo $row2['id'];?>/<?php echo $_GET['id'];?>"><?php echo htmlentities($row2['projectname'])?>  <br /> <br /> 
						 <sub style="display: contents;">  <?php echo htmlentities($row2['category']);?></sub> 	 </a> 
				  <a class="btn btn-danger" style="float: right; margin-top: -5rem;margin-right: 2rem;padding: 5px; z-index: 1;position: relative;" href="edit-project/<?php echo $row2['id'];?>/<?php echo $_GET['id'];?>"> <i class="fa fa-edit"></i></a> 
				  <div class="conainer" >
  <div class="circle_percent" data-percent="<?php echo $row2['percent']/$row2['countmain'];?>">
