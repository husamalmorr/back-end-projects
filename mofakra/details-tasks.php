      ...
      <div class="container">
        ...
        <div class="header-content header-style-five position-relative d-flex align-items-center justify-content-between">
          ...
          <div class="page-heading">
            <h6 class="mb-0">تفاصيل المهمة الرئيسية</h6>
          </div>
          <!-- Navbar Toggler-->
      ...
      <div class="container">
        <div class="card">
          <div class="card-body p-3">
			...
			$mainid=$_GET['mainid'];
			$id=$_GET['id'];
						$query=mysqli_query($con,"select * from main inner join sub on sub.mainname=main.mainname and sub.owner=main.owner where main.id='$mainid'");
            ...
            <!-- Page Item--><a class="page--item" href="edit-task/<?php echo $row['id'];?>/<?php echo $_GET['id'];?>"><?php echo htmlentities($row['subname'])?>  <br /> <br /> 
						 <sub style="display: contents;">  <?php echo htmlentities($row['mainname']);?></sub> 

										  <?php if($row['status']=='غير منجز'&&$row['owner']==$id)
										  {?>
 <a class="btn btn-danger" style="float: right;     padding: 2px; margin-top: -5rem;margin-right: 2rem;padding: 5px; z-index: 1;position: relative;" href="update-main-subtask/<?php echo $row['id'];?>/<?php echo $_GET['id'];?>/<?php echo $row['status'];?> "><i class="fa fa-times">غير منجز</i></a> 

										  <?php } 
										  else 
										  {
											  ?>
						 				  <a class="btn btn-success" style="float: right; margin-top: -5rem;margin-right: 2rem;padding: 5px; z-index: 1;position: relative;" href="update-main-subtask/<?php echo $row['id'];?>/<?php echo $_GET['id'];?>/<?php echo $row['status'];?> "> <i class="fa fa-check"> منجز</i> </a> 
										  <?php }?>
			 </a>
			<?php }?> 
			<?php } 
