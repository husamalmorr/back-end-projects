...
$query=mysqli_query($con,"insert into sub(subname,mainname,description,owner)values('$subname','$mainname','$description','$id')");
$extra="add-task/$id";//
      ...
      <div class="container">
        ...
        <div class="header-content header-style-five position-relative d-flex align-items-center justify-content-between">
          ...
          <div class="page-heading">
            <h6 class="mb-0">اضافة مهمة فرعية</h6>
          </div>
          <!-- Navbar Toggler-->
          ...
          <div class="card-body">
            <div class="contact-form">
              <form method="post" action="">
                  ...
                  <input class="form-control" name="subname" type="text" placeholder="اسم المهمة الفرعية" required>
                </div>
				  	 <div class="form-group mb-3">
                  <select class="form-select" name="mainname">
				   <?php $id=$_GET['id'];
				   $query2=mysqli_query($con,"select distinct mainname from main where owner='$id'");
				    while($row2=mysqli_fetch_array($query2))
			  {
			  ?>
                    <option value="<?php echo $row2['mainname'];?>"><?php echo $row2['mainname'];?></option>
                  <?php }?>
                  </select>
                ...
                <button type="submit" name="submit"class="btn btn-primary w-100">اضافة مهمة فرعية</button>
              </form>
            </div>
          </div>
        </div>
