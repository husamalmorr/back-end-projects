...
$query=mysqli_query($con,"update sub set subname='$subname', mainname='$mainname',description='$description',status='$status',addedtime='$addedtime' where id='$subid'");
header("location:https://juclinic.000webhostapp.com/page-tasks/$id");

}
if(isset($_POST['del']))
{
	$subid=$_GET['subid'];
	$query=mysqli_query($con,"delete from sub where id='$subid'");
}
?>
      ...
      <div class="container">
        ...
        <div class="header-content header-style-five position-relative d-flex align-items-center justify-content-between">
          ...
          <div class="page-heading">
            <h6 class="mb-0">تعديل المهمة الفرعية</h6>
          </div>
          <!-- Navbar Toggler-->
        ...
        <div class="card mb-3">
          <div class="card-body">
            <div class="contact-form">
			  ...
			  $subid=$_GET['subid'];
			  $query=mysqli_query($con,"select * from sub where id='$subid'");
			  $row=mysqli_fetch_array($query); ?> 
			  
                <div class="form-group mb-3">
                  <input class="form-control"  value="<?php echo $row['subname'];?>" name="subname" type="text" placeholder="اسم المهمة الفرعية" required>
                </div>
				  <div class="form-group mb-3">
                  <input class="form-control"  value="<?php echo $row['mainname'];?>" name="mainname" type="text" placeholder="اسم المهمة الرئيسية" required readonly>
                </div>
                <div class="form-group mb-3">
...
<?php }?>
                ...
                <button  type="submit" name="del"class="btn btn-primary w-100">حذف المهمة الفرعية</button>
              </form>
            </div>
          </div>
        </div>
