    ...
    <div class="header-area" id="headerArea">
      <div class="container">
        ...
        <div class="header-content header-style-five position-relative d-flex align-items-center justify-content-between">
          <!-- Back Button-->
          <div class="back-button"><a href="add-task/<?php echo $_GET['id'];?>"> <i class="fa fa-plus" style="color:white"> </i> </a> </div>
          <!-- Page Title-->
          <div class="page-heading">
            <h6 class="mb-0">المهام الفرعية</h6>
          </div>
          <!-- Navbar Toggler-->
...
<span id="done"> منجز  </span> 
    </div>
    	<div class="chip" id="wrong-chips">
        <span class="icon icon--leadind chip--check">
            <i class="fas fa-check"></i>
        </span>
<span id="wrong"> غير منجز  </span> 
    </div>
            ...
            <!-- Page Item-->
				...
				<?php 
			$id=$_GET['id'];
						$query=mysqli_query($con,"select * from main inner join sub on sub.mainname=main.mainname and sub.owner=main.owner where main.owner='$id'");
            ...
            <!-- Page Item--><div class="test"> <a class="page--item" href="edit-task/<?php echo $row['id'];?>/<?php echo $_GET['id'];?>"><?php echo htmlentities($row['subname'])?>  <br /> <br /> 
						 <sub style="display: contents;"> <?php echo htmlentities($row['mainname']);?> </sub>
						 <sub style="display:none"> <?php echo htmlentities($row['status']);?> </sub>
										  <?php if($row['status']=='غير منجز'&& $row['owner']==$id)
										  {?>
 <a class="btn btn-danger" style="float: right;     padding: 2px; margin-top: -5rem;margin-right: 2rem;padding: 5px; z-index: 1;position: relative;" href="update-task/<?php echo $row['id'];?>/<?php echo $_GET['id'];?>/<?php echo $row['status'];?> "><i class="fa fa-times">غير منجز</i></a> 

										  <?php } 
										  else 
										  {
											  ?>
						 				  <a class="btn btn-success" style="float: right; margin-top: -5rem;margin-right: 2rem;padding: 5px; z-index: 1;position: relative;" href="update-task/<?php echo $row['id'];?>/<?php echo $_GET['id'];?>/<?php echo $row['status'];?> "> <i class="fa fa-check"> منجز</i> </a> 
										  <?php }?>
