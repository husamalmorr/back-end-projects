...
if(isset($_POST['submit']))
{
	...
	$status="غير منجز اليوم";
			$id=$_SESSION['id'];

$query=mysqli_query($con,"insert into daily(taskname,description,status,owner) values('$taskname','$description','$status','$id')");
      ...
      <div class="container">
        ...
        <div class="header-content header-style-five position-relative d-flex align-items-center justify-content-between">
          ...
          <div class="page-heading">
            <h6 class="mb-0">اضافة مهمة يومية</h6>
          </div>
          <!-- Navbar Toggler-->
            ...
            <div class="contact-form">
              <form method="post">
                <div class="form-group mb-3">
                  <input class="form-control" name="taskname" type="text"  required placeholder="اسم المهمة">
                </div>
                <div class="form-group mb-3">
