    ...
    <div class="header-area" id="headerArea">
      <div class="container">
        ...
        <div class="header-content header-style-five position-relative d-flex align-items-center justify-content-between">
          <!-- Back Button-->
          <div class="back-button"><a href="add-main-task/<?php echo $_GET['id'];?>"> <i class="fa fa-plus" style="color:white"> </i> </a> </div>
          <!-- Page Title-->
          <div class="page-heading">
            <h6 class="mb-0">المهام الرئيسية</h6>
          </div>
          <!-- Navbar Toggler-->
        ...
        <div class="card">
          <div class="card-body p-3">
            ...
            <!-- Page Item-->
				...
				<?php 
			$id=$_GET['id'];
			$query=mysqli_query($con,"select * from projects inner join main on projects.projectname=main.projectname and projects.owner=main.owner where main.owner='$id'");
            ...
            <!-- Page Item--><a class="page--item" href="details-tasks/<?php echo $row['id'];?>/<?php echo $_GET['id'];?>"><?php echo htmlentities($row['mainname'])?>  <br /> <br /> 
						 <sub style="display: contents;"> <?php echo htmlentities($row['projectname']);?> </sub>
										  ...
										  $done="منجز";
												$query4=mysqli_query($con,"select  COUNT(projectname) from main where projectname='$projectname' and owner='$id2'");
...
$num4=$row4['COUNT(projectname)'];	
if($num4)
{	
$query5=mysqli_query($con,"update main set countmain='$num4' where projectname='$projectname'");
}
$avg2="0";						  
?>
				  <div class="conainer" >
