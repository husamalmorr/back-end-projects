...
$st='Time Finished';
$st2="قسم الاي تي";
$query=mysqli_query($con,"select tblcomplaints.*,users.fullName as name from tblcomplaints join users on users.id=tblcomplaints.userId where tblcomplaints.status ='$st' and tblcomplaints.state='$st2'and tblcomplaints.date<='$date' ");
$query2=mysqli_query($con,"UPDATE tblcomplaints set status='$st'  where  tblcomplaints.date<='$date'");
}
...
$currentTime = date( 'H:i:s  A', time () );
$date=date('Y-m-d G:i:s A',time () );
$query=mysqli_query($con,"select tblcomplaints.*,users.fullName as name from tblcomplaints join users on users.id=tblcomplaints.userId where tblcomplaints.status ='$st' and tblcomplaints.state='$st3' and tblcomplaints.date<='$date'");
$query2=mysqli_query($con,"UPDATE tblcomplaints set status='$st'  where  tblcomplaints.date<='$date'");
}
...
$currentTime = date( 'H:i:s  A', time () );
$date=date('Y-m-d G:i:s A',time () );
$query=mysqli_query($con,"select tblcomplaints.*,users.fullName as name from tblcomplaints join users on users.id=tblcomplaints.userId where tblcomplaints.status ='$st' and tblcomplaints.state='$st4'and tblcomplaints.date<='$date'");
$query2=mysqli_query($con,"UPDATE tblcomplaints set status='$st'  where  tblcomplaints.date<='$date'");
}
...
$currentTime = date( 'H:i:s  A', time () );
$date=date('Y-m-d G:i:s A',time () );
$query=mysqli_query($con,"select tblcomplaints.*,users.fullName as name from tblcomplaints join users on users.id=tblcomplaints.userId where tblcomplaints.status ='$st' and tblcomplaints.state='$st5'and tblcomplaints.date<='$date'");
$query2=mysqli_query($con,"UPDATE tblcomplaints set status='$st'  where  tblcomplaints.date<='$date'");
}
}
