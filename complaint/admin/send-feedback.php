...
$cid=$_GET['cid'];
$query=mysqli_query($con,"insert into tblcomplaints(mfeedback) values('$feedback')");
$query=mysqli_query($con,"UPDATE tblcomplaints set mfeedback='$feedback' where complaintNumber='$complaintno'");
$query=mysqli_query($con,"delete from tblcomplaints  where date is null");

$ret=mysqli_query($con,"SELECT username from admin where username = '".$_SESSION['alogin']."'");
$num=mysqli_fetch_array($ret);
if($_SESSION['alogin']===$num['username'])
{ 
$query=mysqli_query($con,"insert into tblcomplaints(mfeedback) values('$feedback') where complaintNumber ='$complaintno'");
}
?>
...
{?>
 ...
 <br /> <br /> 
<div class="controls">
												<button  style="margin-left:-180px;"type="submit" name="search" class="btn">ارسال</button>
											</div>
