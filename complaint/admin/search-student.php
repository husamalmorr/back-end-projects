...
<div class="module">
 ...
 <form class="form-horizontal row-fluid" name="id" method="post">
	...
	<div class="control-group">
											<div class="controls">
												<button type="submit" name="search" class="btn" style="color: white;background-color: #ec1c24;">بحث</button>
											<a href="search-student.php">	<button type="submit" name="search" class="btn" style="color: white;background-color: #ec1c24;">اعادة البحث</button> </a>
											</div>
										</div>
										</form>
			<br />
