...
$_SESSION['msg']="تم اضافة تصنيف فرعي !!";
...
if(isset($_GET['del']))
		  {
                  ...
                  $_SESSION['delmsg']="تم حذف تصنيف فرعي !!";
		  }
...
<head>
	...
	<title>المشرف| التصنيف الفرعي</title>
...
<label class="control-label" for="basicinput">الفئة</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">اسم التصنيف</label>
<div class="controls">
<input type="text" placeholder="ادخل اسم التصنيف"  name="subcategory" class="span8 tip" required>
</div>
</div>
