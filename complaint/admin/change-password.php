			...
			<div class="span9">
					<div class="content">
						...
						<div class="module" style="box-shadow: 1px 2px 3px 2px #6262628a;">
							<div class="module-head" style="color: white;background-color: #ec1c24;">
								<h3 style="color:white">تغير كلمة السر للمدير</h3>
							</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">تأكيد كلمة السر الجديدة</label>
<div class="controls">
<input type="password" placeholder="ادخل كلمة السر الجديدة مرة اخرى"  name="confirmpassword" class="span8 tip" required>
</div>
</div>
										...
										<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit" class="btn" style="background-color: #ec1c24; color:white">تأكيد</button>
											</div>
										</div>
									</form>
							</div>
