...
if(isset($_POST['submit']))
{
	...
	$bus=$_POST['bus'];
	$id=intval($_GET['id']);
$sql=mysqli_query($con,"update students set studentname='$student', discount='$discount', phoneno1='$phone1',facebook='$fb',behaivor='$behaivor', academic='$academic',privateedu='$private',interests='$interest',location='$location',bus='$bus' where studentid='$id'");
...
<div class="controls">
<textarea type="text" placeholder="ادخل ملاحظات التواصل الاجتماعي"  name="facebook" value="<?php echo  htmlentities($row['facebook']);?>" class="span8 tip" required > <?php echo  htmlentities($row['facebook']);?></textarea>
</div>
</div>
<br />
<div class="form-group">
...
<div class="controls">
<input type="text" placeholder="ادخل اهتمامات الطالب"  name="interest" value="<?php echo  htmlentities($row['interests']);?>" class="span8 tip" required>
</div>
</div>
<br />
<div class="form-group">
