...
?>
												...
												<button class="btn"> <a href="add-student.php"> اضافة طالب </a> </button>
									...
									<thead>
										<tr>
											...
											<th>ملاحظات التواصل الاجتماعي</th>
											
											
											
                                              <th> المستوى السلوكي </th>
											<th> المستوى الاكاديمي </th>
											<th> تفريد التعليم </th>
											<th> الاهتمامات </th>
...
?>		
										...
										<td><?php echo htmlentities($row['studentid']);?></td>
											...
											<td><?php echo htmlentities($row['privateedu']);?></td>
											<td><?php echo htmlentities($row['interests']);?></td>
