...
$_SESSION['msg']="تم اضافة القسم!!";
$sql3=mysqli_query($con,"insert into it(state) values('$state') select username from it where username='$employee'");
}
...
{?>
									...
									<strong>تم الاضافة</strong>	<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
									</div>
<?php } ?>
...
<label class="control-label" for="basicinput">اسم القسم</label>
<div class="controls">
<input type="text" placeholder="ادخل اسم القسم"  name="state" class="span8 tip" required>
</div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/js/select2.min.js"></script>
	<label class="col-sm-2 col-sm-2 control-label">اسم الموظف</label> 
	<div class="col-sm-4">
	        <select class="form-control select2" id="employee" name="employee" onChange="getUsers(this.value);" required="required">
	           <?php 
    
          
$sql=mysqli_query($con,"select * from it  ");
