...
$sql2=mysqli_query($con,"update supervisorit set username='$username', password='$password'");
$_SESSION['msg']="تم التحديث بنجاح !!";
	}
		if($_GET['state'] ==='قسم اللوازم')
	{
$sql=mysqli_query($con,"update supervisorguide set username='$username', password='$password' where id='$id'");
$_SESSION['msg']="تم التحديث بنجاح !!";
	}
			if($_GET['state'] =='القسم التربوي و الارشاد')
	{
$sql=mysqli_query($con,"update supervisoredu set username='$username', password='$password' where id='$id'");
$_SESSION['msg']="تم التحديث بنجاح !!";
	}
				if($_GET['state'] =='قسم المالية')
	{
$sql=mysqli_query($con,"update supervisormoney set username='$username', password='$password' where id='$id'");
$_SESSION['msg']="تم التحديث بنجاح !!";
	}
				if($_GET['state'] =='قسم المواصلات')
	{
$sql=mysqli_query($con,"update esupervisorbus set username='$username', password='$password' where id='$id'");
$_SESSION['msg']="تم التحديث بنجاح !!";
	}
					if($_GET['state'] =='القسم الاكاديمي')
	{
$sql=mysqli_query($con,"update supervisoracademic set username='$username', password='$password' where id='$id'");
$_SESSION['msg']="تم التحديث بنجاح !!";
	}
}
