...
$sql2=mysqli_query($con,"insert into students(studentid,studentname,discount,phoneno1,behaivor,academic,location,bus,subcategory) values('$id','$student','$discount','$phone1','$behaivor','$academic','$location','$bus','$subcategory')");

 echo("Error description: " . mysqli_error($con));
$_SESSION['msg']="تم اضافة طالب !!";
...
while ($rw=mysqli_fetch_array($sql)) {
  ?>
                  ...
                  <option name="subcategory" value="<?php echo $rw['subcategory']?>" ><?php echo $rw['subcategory']?></option>
