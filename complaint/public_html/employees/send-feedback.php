...
{ 
$query=mysqli_query($con,"insert into tblcomplaints(feedback) values('$feedback') where complaintNumber ='$complaintno'");
}
else 
{
...
$query=mysqli_query($con,"delete from tblcomplaints  where date is null");
?>
  <input  name ='feedback' type='text' value="لم يتم حل الشكوى رقم <?php echo htmlentities($cid);?>">
	...
	<div class="control-group">
											<div class="controls">
												<button type="submit" name="search" class="btn">ارسال</button>
											</div>
										</div>
										</form>
