...
$successmsg="تم تغير كلمة السر بنجاح !!";
}
else
{
$errormsg="كلمة السر القديمة غير صحيحة !!";
}
}
?>
...
<html lang="en">
  <head>
    ...
    <title>نظام ادارة الشكاوي | تغير كلمة سر المستخدم</title>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> تغير كلمة السر</h3>
          	
          	<!-- BASIC FORM ELELEMNTS -->
          	<div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> تغير كلمة السر للمستخدم</h4>
 ...
 <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                      ...
                      <form class="form-horizontal style-form" method="post" name="chngpwd" onSubmit="return valid();">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">كلمة السر الحالية</label>
                              <div class="col-sm-10">
...
<div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">كلمة السر الجديدة</label>
                              <div class="col-sm-10">
...
<div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">تأكيد كلمة السر الجديدة</label>
                              <div class="col-sm-10">
