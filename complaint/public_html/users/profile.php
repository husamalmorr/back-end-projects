...
if($query)
{
$successmsg="تم تحديث الملف الشخصي !!";
}
else
{
...
<html lang="en">
  <head>
    ...
    <title>نظام ادارة الشكاوي | الملف الشخصي</title>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> الملف الشخصي</h3>
 ...
 ?>                     
  ...
  <h4 class="mb"><i class="fa fa-user"></i>&nbsp;&nbsp;<?php echo htmlentities($row['fullName']);?>'ملف</h4>
    <h5><b>اخر نحديث</b>&nbsp;&nbsp;<?php echo htmlentities($row['updationDate']);?></h5>
                      <form class="form-horizontal style-form" method="post" name="profile" >

<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">الاسم الكامل</label>
<div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label">تاريخ التسجيل</label>
<div class="col-sm-4">
...
<a href="update-image.php">تغير الصورة</a>
<?php else:?>
