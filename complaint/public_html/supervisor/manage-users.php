...
<?php include('include/sidebar.php');?>				
	...
	<div class="module" style="box-shadow: 1px 2px 3px 2px #6262628a;background: aliceblue;">
							<div class="module-head" style="color: white; background-color:  #46be8a;">
								<h3 style="color:white">ادارة المستخدمين</h3>
							</div>
...
color: white;" >#</th>
											<th style="background: #46be8a;
color: white;"> الاسم</th>
											<th style="background: #46be8a;
color: white;">البريد الالكتروني </th>
											<th style="background: #46be8a;
color: white;">رقم الهاتف</th>
											<th style="background: #46be8a;
color: white;">تاريخ التسجيل </th>
											<th style="background: #46be8a;
...
<button type="button" class="btn btn-primary" style="background: #46be8a;">عرض التفاصيل</button>
											</a>
		<?php 
