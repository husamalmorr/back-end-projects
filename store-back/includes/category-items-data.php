<?php
$cname=$_GET['cname'];
$query=mysqli_query($conn,"select * from items where cname='$cname'");
if(isset($_POST['search'])){
	$itemname=$_POST['itemname'];
	$sql=mysqli_query($conn,"select * from items where itemname='$itemname' and cname='$cname'");
$msg="<script> window.location='search.php?itemname=$itemname&cname=$cname';
 </script> ";
  	echo $msg;
}
?>
    ...
    <section class="u-clearfix u-section-2" id="sec-25c1">
      <div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
        <h1 class="u-align-left u-text u-text-1"><?php echo $cname;?></h1> <br />
		<form method="post"> 
